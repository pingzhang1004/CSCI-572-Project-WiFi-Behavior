...
RoutingExperiment::Run (double txp, std::string CSVfileName)
{
  ...
  //Config::SetDefault ("ns3::WifiRemoteStationManager::RtsCtsThreshold", StringValue ("0"));//zhe ge    kaiqi 
  ...
  wifiChannel.AddPropagationLoss ("ns3::FriisPropagationLossModel");// chuan shu  sun hao  moxing
 ...
 AsciiTraceHelper ascii;
  Ptr<OutputStreamWrapper> osw = ascii.CreateFileStream ("ganrao-wifi-phy.tr");
